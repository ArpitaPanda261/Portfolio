    ...
    >
      <div className="container mx-auto px-6">
        <motion.div
          ...
          className="text-center mb-16 about-section"
        >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="w-80 h-80 bg-gradient-to-br from-blue-500/20 to-blue-700/20 rounded-2xl border border-blue-400/30 mx-auto mb-8 flex items-center justify-center">
                <div className="text-8xl">🚀</div>
              </div>
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center">
                <span className="text-xl-center font-bold">React 2+</span>
              </div>
            </div>
          </motion.div>
